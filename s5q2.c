...
// Function to create a min heap of capacity equal to size and insert all characters of data[] in
min heap.
...
// Best Case Complexity: O(nlogn)// Worst Case Complexity: O(nlogn)
int main() {
